...
const CategoryHeader = () => {
  return (
    <div className="relative h-[180px] overflow-hidden">
      {/* Background */}
      <div 
        className="absolute top-0 left-0 w-full h-[140%] -translate-y-10 transform-gpu transition-transform duration-[2s] ease-out"
        style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 h-full">
        <div className="flex items-center justify-between h-full pt-8">
          {/* Logo Section */}
          <Link 
            to="/"
      ...
      <div 
        className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-[#F6EFE9] to-transparent"
