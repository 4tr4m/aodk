...
export const historiaCategories = [
  { link: '/historia/o-mnie', label: 'O Mnie' },
  { link: '/historia/o-autyzmie', label: 'O Autyźmie' }
];

export const znajdkiCategories = [
